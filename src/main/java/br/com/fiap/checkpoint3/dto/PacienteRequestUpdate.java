...
public class PacienteRequestUpdate {
    ...
    public PacienteRequestUpdate() {}

    public PacienteRequestUpdate(String nome, String endereco, String bairro, String email, String telefoneCompleto, LocalDate dataNascimento) {
        this.nome = nome;
